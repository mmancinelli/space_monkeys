...
var scrollVis = function () {
    ...
    var setupVis = function (wordData, fillerCounts, histData) {
        ...
        g.append('g')
            ...
            .call(xAxisBar);
        g.select('.x.matrixaxis').style('opacity', 0);
    ...
    function groupByWord(words) {
        ...
        //     .rollup(v => v.length)
        //     .entries(data);
        // return d3.rollup(words, v=>v.length, d=>d.key).sort((a,b)=>d3.descending(b.value, a.value));
    }
